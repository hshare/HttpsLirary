...
//            sslSocketFactory = MySSLSocketFactory.getFixedSocketFactory();
        	sslSocketFactory = SSLSocketFactoryEx.getSocketFactory();
        } else {
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, String.format("android", "1.1"));
...
//        httpClient = HttpClientHelper.getHttpClient();
        httpClient = HttpClientHelper.getHttpClient(httpParams, cm);
